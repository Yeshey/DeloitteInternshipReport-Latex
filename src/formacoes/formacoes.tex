\section{Formações}\label{sec:formacoes}
    ...
    \begin{comment}
      \ganttbar{PL/SQL)}{2023-09-18}{2023-09-20} \\
Devops e cloud - 14/09-15/09
PL/SQL - 18/09-19/09-Manha do dia 20/09
JAVA - Tarde do dia 20/09 - 21/09 - 22/09
EXCEL - 25/09 - 26/09
Formação de SQL e modelização - 27/09 - 28/09
Formação boas práticas de desenvolvimento - 29/09
Banca - Manhã do dia 2/10
Seguros - Tarde do dia 2/10
Agile/Scrum - Manhã do dia 3/10
Formação getting thigs done - Metade da tarde do dia 3/10
Formação CMMI - Resto da tarde do dia 3/10
Formação de testes - 4/10 e dia 06/10, 5 de outubro nada feriado acho
Depois começou as individuais que tive serviço now e q:
Tive serviço now de 9/10 até 13/10
depois foi azure 2 semanas
    \end{comment}

    %PL/SQL, Java, Excel, SQL e Modelação, Boas Práticas de Desenvolvimento, Banca, Seguros, Agile/Scrum, Getting Things Done, Capability Maturity Model Integration (CMMI), Testes, OutSystems e Azure
