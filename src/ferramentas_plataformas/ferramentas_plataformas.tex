\section{Ferramentas e Plataformas usadas no desenvolvimento da RIL}
    ...
    \subsection{OutSystems}\label{sec:outsystems}
        ...
        \input{src/ferramentas_plataformas/OS/center-studio-lifetime.tex}

        \input{src/ferramentas_plataformas/OS/guia-boas-praticas-os.tex}

        \input{src/ferramentas_plataformas/OS/competidores-os.tex}
